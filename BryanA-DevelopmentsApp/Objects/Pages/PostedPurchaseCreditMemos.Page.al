page 50051 "BA Posted Req. Credit Memos"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Posted Requsition Credit Memos';
    ...
    SourceTableView = SORTING ("Posting Date") ORDER(Descending) where ("BA Requisition Order" = const (true));
        ...
        area(navigation)
        {
            group("&Cr. Memo")
            {
                ...
                action("Co&mments")
                {
                    ...
                    RunPageLink = "Document Type" = CONST ("Posted Credit Memo"), "No." = FIELD ("No.");
