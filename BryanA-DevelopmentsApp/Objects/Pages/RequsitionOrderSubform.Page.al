// page 80002 "BA Req. Order Subform"
// {
//     AutoSplitKey = true;
//     Caption = 'Lines';
//     DelayedInsert = true;
...
//                 {
//                     ApplicationArea = Basic, Suite;
//                     ToolTip = 'Specifies the Tax product posting group. Links business transactions made for the item, resource, or G/L account with the general ledger, to account for Tax amounts resulting from trade with that record.';
//                     Visible = false;
